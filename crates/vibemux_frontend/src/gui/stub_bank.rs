...
pub const BANK: &[(AgentKind, &[&str])] = &[
    ...
    (
        ...
        &[
            ...
            "    hello (stub)",
            "    > list tools",
            "    0 tools registered (stub)",
            "  tokens: 0 in / 0 out (stub)",
            "  model: iflow-default (stub)",
            "  status: idle",
            "iflow> ",
            "...",
            "(no live PTY attach in this slice)",
    ...
    (
        ...
        &[
            ...
            "    12 files (stub)",
            "    > run checks",
            "    passed: 0, failed: 0 (stub)",
            "  tokens: 0 in / 0 out (stub)",
            "  model: trae-default (stub)",
            "  status: idle",
            "trae> ",
            "...",
            "(no live PTY attach in this slice)",
    ...
    (
        ...
        &[
            ...
            "    up to date (stub)",
            "    > test",
            "    0 passed, 0 failed (stub)",
            "  tokens: 0 in / 0 out (stub)",
            "  model: codebuddy (stub)",
            "  status: idle",
            "codebuddy> ",
            "...",
            "(no live PTY attach in this slice)",
