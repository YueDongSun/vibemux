...
- Plugin stdio：`vibemux_plugin_protocol` 已实现private pre-alpha Protobuf v1 schema、固定上限framing、manifest/negotiation与session lifecycle；尚无process supervisor、SDK或真实plugin，stdout/stderr隔离仍需M4.1实证。
